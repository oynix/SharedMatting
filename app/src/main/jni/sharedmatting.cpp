...
void SharedMatting::loadImage(char * filename)
{
    ...
    LOGE("height = %d, width = %d, step = %d, channels = %d", height, width, step, channels);
...
{
//    LOGE("nChannels = %s", filename);
//    LOGE("nChannels = %d", matte->nChannels);
//    __android_log_print(ANDROID_LOG_ERROR, LOG, (const char *) matte->nChannels);
//    LOGE("alphaChannel = %d", matte->alphaChannel);
//    LOGE("depth = %d" , matte->depth);
//    LOGE("height = %d" , matte->height);
//    LOGE("width = %d" , matte->width);
//    LOGE("widthStep = %d" , matte->widthStep);
//    LOGE("imageData = %s" , matte->imageData);
//    LOGE("nSize = %d" , matte->nSize);
